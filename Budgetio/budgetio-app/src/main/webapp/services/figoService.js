...
(function() {
	var figoService = function($http) {
		...
		var getUser = function() {			
			var serviceUrl = "http://localhost:8080/budgetio-app/rest/getUser";
		...
		var getAccounts = function() {			
			var serviceUrl = "http://localhost:8080/budgetio-app/rest/getAccounts";
			return $http.get(serviceUrl)
				.success(function(data) {
					if (console){
		...
		var getTransactions = function() {			
			var serviceUrl = "http://localhost:8080/budgetio-app/rest/getTransactions";
			return $http.get(serviceUrl)
				.success(function(data) {
					if (console){
		...
		var getNotifications = function() {			
			var serviceUrl = "http://localhost:8080/budgetio-app/rest/getNotifications";
			return $http.get(serviceUrl)
				.success(function(data) {
					if (console){
		...
		var getPayments = function() {			
			var serviceUrl = "http://localhost:8080/budgetio-app/rest/getPayments";
			return $http.get(serviceUrl)
				.success(function(data) {
					if (console){
